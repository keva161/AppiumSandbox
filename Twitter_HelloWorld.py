...
driver.find_element_by_xpath('//android.widget.FrameLayout[@content-desc="Edit Tweet 1 of 1"]/android.widget.FrameLayout/android.widget.LinearLayout[1]/android.widget.FrameLayout/android.widget.EditText').clear()
driver.find_element_by_xpath('//android.widget.FrameLayout[@content-desc="Edit Tweet 1 of 1"]/android.widget.FrameLayout/android.widget.LinearLayout[1]/android.widget.FrameLayout/android.widget.EditText').send_keys("Hello world! #SentFromAppium")
